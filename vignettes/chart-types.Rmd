...
```{r col-horizontal, fig.height = 4.6}
...
```{r col-horizontal-dodged, fig.height = 4.6}
pv <- expand.grid(
  inkomensgroep = factor(groepen, levels = rev(groepen)),
...
```{r box-single, fig.width = 6, fig.height = 3.2}
...
```{r box-dodged, fig.width = 6, fig.height = 3.6}
