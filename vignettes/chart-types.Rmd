...
* `vignette("ggcpb")` -- the composable core the wrappers are built
  on, as an end-to-end walkthrough.
...
`"ggcpb"`. For the vertically grouped distributional layout (boxes
organised under bold group headings) see `vignette("layouts")`.
...
* Arrange more than one chart's worth of information -- grouped
  category axes, facets and choropleth maps -- in `vignette("layouts")`.
