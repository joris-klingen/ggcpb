...
```{r draft, fig.width = 5.96, fig.height = 3.2, out.width = "700px"}
kk <- huishoudens |>
  summarise(
...
```{r refine, fig.width = 5.96, fig.height = 3.2, out.width = "700px"}
...
```{r facets, fig.width = 5.96, fig.height = 2.2, out.width = "700px"}
