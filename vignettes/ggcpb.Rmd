...
their wrapper calls, see `vignette("chart-types")`.
...
Not every figure is a line, column, area or boxplot. For anything
else -- here a scatter of income against the energy bill -- you build
from raw `ggplot2` and apply the same core pieces the wrappers use:
